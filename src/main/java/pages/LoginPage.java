...
public class LoginPage {
    public SelenideElement loginHeader = $x("//div[text()='Login']");
  ...
  //  public SelenideElement invalidUsernameAndPasswordMessage = $("[id='name']");
    public SelenideElement offBullets = $x("//*[text()='off Bullets']");
    public SelenideElement rememberMeCheckbox = $(byText("Remember me"));
    public SelenideElement resetPasswordButton = $(byText("Reset password"));
    public SelenideElement continueWithGoogleButton = $(byText("Continue with Google"));
    public SelenideElement loginViaFacebookButton = $(byText("Login via Facebook"));
